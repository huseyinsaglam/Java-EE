...
public class JPAtest {
	...
	public static void main(String[] args) {
		...
		Phone phone3 = new Phone("MOBÝLE", "333333");
		Phone phone4 = new Phone("HOME", "4444444");
		Phone phone5 = new Phone("MOBÝLE", "5555555");
		...
		employerDAO.updatePhone(employer1, nickname1);
		employerDAO.updatePhone(employer2, nickname2);
