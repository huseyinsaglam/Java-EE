...
public class JPAtest {
	...
	public static void main(String[] args) {
		...
		ParkingSpaceDAO parkingSpaceDAO = new ParkingSpaceImpl(entityManager);
		
		ParkingSpace parkingSpace1 = new ParkingSpace("A11",2);
		ParkingSpace parkingSpace2 = new ParkingSpace("B12",1);
		ParkingSpace parkingSpace3 = new ParkingSpace("C13",5);
		
		
		parkingSpaceDAO.insertEmployer(parkingSpace1);
		parkingSpaceDAO.insertEmployer(parkingSpace2);
		parkingSpaceDAO.insertEmployer(parkingSpace3);
		
		
		employerDAO.updateSpace(employer, parkingSpace1);
		employerDAO.updateSpace(employer1, parkingSpace2);
		employerDAO.updateSpace(employer2, parkingSpace3);
